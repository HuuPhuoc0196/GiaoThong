...
<!-- services -->
							...
							<div class="menu-grids my-lg-4 my-md-2">
								<div class="row inner-menu mt-4">
									<div class="col-md-6 menu-grid-left" data-aos="fade-down">
										<div class="row mt-2">
											<div class="col-md-5 menu-img">
												<img src="<?php echo base_url_ci;?>public/images/1.jpg" class="img-fluid rounded-circle" alt="">
											</div>
											<div class="col-md-7 menu-img-info mt-4 mt-md-2">
												...
												<p class="sub-meta mt-2">
													...
													Giờ cập nhật </p>
                                                    <p><a style="color:#030">Nguồn trang </a></p>
													<p style ="text-size:16px;">Noi dung tom tat</p>
											</div>
										</div>
									...
									<div class="col-md-6 menu-grid-right" data-aos="fade-down">
										<div class="row mt-2">
											<div class="col-md-5 menu-img">
												<img src="<?php echo base_url_ci;?>public/images/2.jpg" class="img-fluid rounded-circle" alt="">
											</div>
											<div class="col-md-7 menu-img-info mt-4 mt-md-2">
												<h5>Tiêu đề bài viết</h5>
												<p class="sub-meta mt-2">
								...
								<div class="row inner-menu mt-4">
									<div class="col-md-6 menu-grid-left" data-aos="fade-down">
										<div class="row mt-2">
											<div class="col-md-5 menu-img">
												<img src="<?php echo base_url_ci;?>public/images/3.jpg" class="img-fluid rounded-circle" alt="">
											</div>
											<div class="col-md-7 menu-img-info mt-4 mt-md-2">
												<h5>Tiêu đề bài viết</h5>
												<p class="sub-meta mt-2">
									...
									<div class="col-md-6 menu-grid-right" data-aos="fade-down">
										<div class="row mt-2">
											<div class="col-md-5 menu-img">
												<img src="<?php echo base_url_ci;?>public/images/4.jpg" class="img-fluid rounded-circle" alt="">
											</div>
											<div class="col-md-7 menu-img-info mt-4 mt-md-2">
												<h5>Tiêu đề bài viết</h5>
												<p class="sub-meta mt-2">
	...
	<section class="grid-info-section">
		<div class="container">
			<h3 class="tittle">Điểm kẹt xe nhiều nhất</h3>
			<div class="row inner-sec">
				<ul id="flexiselDemo1">
					<li>
						<div class="blog-item text-center">
							<img src="<?php echo base_url_ci;?>public/images/1.jpg" alt=" " class="img-fluid rounded-circle" />
							<div class="floods-text">
							<a href="#"><h3>Điểm 1</h3></a>
					...
					<li>
						<div class="blog-item text-center">
							<img src="<?php echo base_url_ci;?>public/images/2.jpg" alt=" " class="img-fluid rounded-circle" />
							<div class="floods-text">
								<a href="#"><h3>Điểm 2</h3></a>
					...
					<li>
						<div class="blog-item text-center">
							<img src="<?php echo base_url_ci;?>public/images/3.jpg" alt=" " class="img-fluid rounded-circle" />
							<div class="floods-text">
							<a href="#"><h3>Điểm 3</h3></a>
							</div>
						</div>
					</li>
					<li>
						<div class="blog-item text-center">
							<img src="<?php echo base_url_ci;?>public/images/4.jpg" alt=" " class="img-fluid rounded-circle" />
							<div class="floods-text">
							<a href="#"><h3>Điểm 4</h3></a>
							</div>
						</div>
					</li>
					<li>
						<div class="blog-item text-center">
							<img src="<?php echo base_url_ci;?>public/images/5.jpg" alt=" " class="img-fluid rounded-circle" />
							<div class="floods-text">
								<a href="#"><h3>Điểm 5</h3></a>
